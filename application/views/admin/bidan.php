                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                                ...
                                                <?php foreach ($bidan as $bidan) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $bidan['alamat'] ?></td>
                                                        <td><?= $bidan['no_tlpn'] ?></td>
                                                        <td> <a href="/posyandu/index.php/ubah/bidan/<?= $bidan['kd_bidan'] ?>"><button type="button" class="btn btn-primary waves-effect waves-light width-md">ubah</button></a>

                                                            <a href="/posyandu/index.php/hapus/bidan/<?= $bidan['kd_bidan'] ?>"><button type="button" class="btn btn-danger waves-effect waves-light width-md">hapus</button></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach ?>
