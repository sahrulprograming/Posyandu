                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Jadwal Posyandu</h4>
                                    <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                <a href="#" data-toggle="modal" data-target="#add-category" class="btn btn-lg font-16 btn-primary btn-block waves-effect m-t-20 waves-light">
                                                <i class="mdi mdi-plus-circle-outline"></i> Tambah Jadwal Posyandu
                                            </a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header border-bottom-0">
                                                <h4 class="modal-title">Isi form Jadwal Posyandu</h4>
                                            ...
                                            <div class="modal-body p-3">
                                                <form action="" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control form-white" placeholder="masukan jam" type="text" name="nik"/>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label">Di Buat Pada</label>
                                                        <input class="form-control form-white" placeholder="dibuat pada" type="text" name="nik"/>
                                                    </div>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <a href=""><button type="button" class="btn btn-danger waves-effect waves-light width-md">hapus</button></a>
                                                </td>
                                            </tr>
